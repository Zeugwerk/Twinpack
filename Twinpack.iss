...
begin  
  ...
  begin
    ...
    begin
      ...
      begin
        ShellExec('', InstallationPaths[i] + '\Common7\IDE\VSIXInstaller.exe', '/force ' + '/u:TwinpackVsix.26e0356d-ac0e-4e6a-a50d-dd2a812f6f23', '', SW_HIDE, ewWaitUntilTerminated, ReturnCode);
