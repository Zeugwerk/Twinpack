...
namespace TwinpackTests
{
    ...
    public class TwinpackServiceTest
    {
        ...
        public async Task DownloadPackageVersionAsync_PackagesWithDependencies()
        {
            ...
            Assert.IsNotNull(downloadedPackageVersions.FirstOrDefault(x => x.PackageVersion.Name == "ZCore").PackageServer);
            Assert.IsNotNull(downloadedPackageVersions.FirstOrDefault(x => x.PackageVersion.Name == "ZPlatform").PackageServer);
            Assert.IsNotNull(downloadedPackageVersions.FirstOrDefault(x => x.PackageVersion.Name == "ZAux").PackageServer);
            Assert.IsNotNull(downloadedPackageVersions.FirstOrDefault(x => x.PackageVersion.Name == "ExternalLib1").PackageServer);
            Assert.IsNotNull(downloadedPackageVersions.FirstOrDefault(x => x.PackageVersion.Name == "ExternalLib2").PackageServer);
            Assert.IsNotNull(downloadedPackageVersions.FirstOrDefault(x => x.PackageVersion.Name == "ExternalLib3").PackageServer);
